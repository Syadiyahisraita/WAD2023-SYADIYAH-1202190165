            ...
            <div class="card">
                <div class="card-body">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if ($_POST['tinggi_badan'] == null && $_POST['berat_badan'] == null) {
                            echo "Tinggi badan dan berat badan tidak boleh kosong";
                        } elseif ($_POST['berat_badan'] == null) {
                            echo "kolom berat badan belum terisi";
                        } elseif ($_POST['tinggi_badan'] == null) {
                            echo "kolom tinggi badan belum terisi";
                        } else {
                            $hasil = $berat_badan / ($tinggi_badan / 100);
                            echo "Nilai BMI: " .  round($hasil, 1);
    
                            echo '<br> Status BMI: ';
                            if (round($hasil, 1) <= 18.4) {
                                echo "Underweight";
                            } elseif (round($hasil, 1) >= 18.5 && round($hasil, 1) <= 24.9) {
                                echo "Normal";
                            } elseif (round($hasil, 1) >= 25.0 && round($hasil, 1) <= 39.9) {
                                echo "Overweight";
                            } else {
                                echo "Obese";
                            }
